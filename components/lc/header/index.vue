            ...
            <ul class="d-flex navbar-nav">
              ...
              <li class="nav-item d-md-flex d-sm-none">
                ...
                <v-btn
                  ...
                  flat
                >
                  <NuxtLink to="/" target="_blank" class="text-decoration-none text-dark">Download Free</NuxtLink>
                </v-btn>
              </li>
            </ul>
          </div>
    ...
    <ul class="navbar-nav py-4 ">
      ...
      <li class="nav-item ml-3 mr-3">
        ...
        <v-btn color="error" block flat>
         <NuxtLink to="https://www.artemsopa.com/templates/nextkit-nuxtjs-free-uikit/" target="_blank" class="text-decoration-none text-white">Download Free</NuxtLink>
        </v-btn>
      </li>
    </ul>
  </v-navigation-drawer>
